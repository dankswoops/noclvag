...
#if !defined(__NOCLVAG_AVL_H__)
#define __NOCLVAG_AVL_H__ 1
...
static inline void avl_root_init(avl_root_t* rootp) { rootp->ar_root = NULL; }
...
static void avl_delete_fix(avl_root_t* rootp, avl_item_t* itemp,
                           avl_item_t* parentp) {
  avl_item_t* childp;
...
#endif /* !defined (__NOCLVAG_AVL_H__) */
